...
FONT_PREFS_LINUX = [
    ("DejaVu Sans Mono", "***REMOVED-BASE64***.ttf"),
    ("Liberation Mono", "***REMOVED-BASE64***-Regular.ttf"),
    ("Noto Sans Mono", "***REMOVED-BASE64***-Regular.ttf"),
    ("Ubuntu Mono", "***REMOVED-BASE64***-R.ttf"),
]
FONT_PREFS_WINDOWS = [
...
all_chars.update("***REMOVED-BASE64*** .,-:;!?/|")
