...
summary: Expose Claude Code integration and MCP server to Hermes and Obsidian
tags: [integration, claude, mcp]

description: |
  This skill documents how Claude Code can access Hermes' procedural skills
  and the Obsidian vault via workspace links and a minimal MCP-like server.

triggers:
  - trigger: "claude-integration"
    examples:
      - "Integrate Claude with Hermes knowledge base"

steps:
  - step: "Ensure workspace has junctions to Hermes skills and Obsidian vault"
...
notes: |
  Reference Obsidian note: Obsidian Vault/Hermes Memories/2026-06-11 Claude integration.md
  This skill was auto-generated from that note to make the integration discoverable by Hermes.
