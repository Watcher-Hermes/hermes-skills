...
def read_token(token_file=None):
    ...
    default_paths = [
        ...
        os.path.expanduser(r"~\AppData\Local\hermes\skills\research\paper-deep-reader\.mineru_token"),
        os.path.expanduser(r"~\.hermes\skills\research\paper-deep-reader\.mineru_token"),
