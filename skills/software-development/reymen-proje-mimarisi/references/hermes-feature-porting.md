...
- R>eYMeN identity kurallari (Turkce, try/except)
...
- Context: mevcut R>eYMeN kod ornegi (kanban.py, skills_config.py pattern'i)
- Her dosya icin: docstring + try/except + Renk sinifi + PROJE_KOK pattern
- R>eYMeN identity kurallari: Turkce isimlendirme, `sys.path.insert(0, str(PROJE_KOK))`
