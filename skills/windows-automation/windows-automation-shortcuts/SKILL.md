...
Veya manuel:
```bash
schtasks /create /tn "Hermes-Listener" /tr "C:\Users\marko\AppData\Local\hermes\hermes-agent\venv\Scripts\python.exe C:\Users\marko\hermes_listener.py" /sc onlogon /delay 0000:30 /rl highest /f
```
