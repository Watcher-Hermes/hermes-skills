...
### 1. UI Dump Al
```bash
***REMOVED-BASE64***-tools/adb.exe shell uiautomator dump /sdcard/ui.xml
***REMOVED-BASE64***-tools/adb.exe pull /sdcard/ui.xml /c/Users/marko/Desktop/
```
...
### 3. Tıkla
```bash
***REMOVED-BASE64***-tools/adb.exe shell input tap <center_x> <center_y>
```
...
***REMOVED-BASE64***-tools/adb.exe shell dumpsys activity services com.package | grep "app=ProcessRecord"
# PID'den log
***REMOVED-BASE64***-tools/adb.exe shell logcat -d --pid=<PID>
```

### Servis Durumu Kontrolü
```bash
***REMOVED-BASE64***-tools/adb.exe shell dumpsys activity services com.package
...
# 2. APK'yı yükle
***REMOVED-BASE64***-tools/adb.exe install "C:\Users\marko\Desktop\LiveTranscriber.apk"

# 3. Uygulamayı başlat
***REMOVED-BASE64***-tools/adb.exe shell am start -n com.<package>/.MainActivity
...
***REMOVED-BASE64***-tools/adb.exe exec-out screencap -p > "C:\Users\marko\Desktop\emu_screen.png"
```
